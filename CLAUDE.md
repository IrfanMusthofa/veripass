...
### Oracle Processing
- Polls `service_records` table for unprocessed records
- Verifies and submits events to EventRegistry contract
- Updates record status: PENDING → PROCESSING → COMPLETED/FAILED
